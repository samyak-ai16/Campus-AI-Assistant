        ...
        <div className="flex-1 space-y-4 overflow-y-auto p-6">
          ...
          {loading && (
            <div className="flex gap-3 items-start animate-fade-in">
              ...
              <div className="rounded-2xl bg-muted px-4 py-3 text-xs text-muted-foreground flex items-center gap-2.5 shadow-sm">
                <Loader2 className="h-3.5 w-3.5 animate-spin text-primary shrink-0" />
                <span className="font-medium">Searching campus knowledge & formulating answer...</span>
